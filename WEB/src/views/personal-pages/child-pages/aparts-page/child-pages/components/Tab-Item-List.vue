<template>
  <v-container fluid>
    ...
    <v-card class="my-1" outlined v-for="i in 5" :key="i">
      <v-list-item>
        <v-row align="center" no-gutters>
          <v-col cols="8"> İTEM ADI </v-col>
          <v-col cols="4" class="text--secondary">
            <v-row align="center" no-gutters style="width: 100%">
              <v-col cols="9"> Verilen Tarih: 11.12.2022 </v-col>
              <v-col cols="3">
                <v-btn color="error" @click="(dialog = true), (dialogType = 'delete'), (selectedItem = '')" icon>
