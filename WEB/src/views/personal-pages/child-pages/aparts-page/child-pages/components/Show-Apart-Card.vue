    ...
    <v-card outlined>
      <v-list-item>
        <v-list-item-content three-line>
          ...
          <v-list-item-subtitle> <span class="font-weight-bold">NO: </span> {{ fakeApartData.apartName }} </v-list-item-subtitle>
          <v-list-item-subtitle> <span class="font-weight-bold">TİP: </span> {{ fakeApartData.apartType ? "Daire" : "Ofis" }} </v-list-item-subtitle>
          <v-list-item-subtitle> <span class="font-weight-bold">ODA SAYISI: </span> {{ fakeApartData.apartRoomCount }} </v-list-item-subtitle>
        </v-list-item-content>
      </v-list-item>
    ...
    <v-dialog v-model="dialog" persistent max-width="300">
      ...
      <v-card v-show="dialogType == 'update'">
        ...
        <div class="mx-2">
          ...
          <div class="d-flex justify-center">
            <v-radio-group v-model="fakeApartData.apartType">
              <v-radio label="Ofis" value="false" />
              <v-radio label="Daire" value="true" />
            </v-radio-group>
          </div>
        </div>
        <v-card-actions>
